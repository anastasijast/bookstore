...
namespace Bookstore.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var bookstoreContext = _context.Order.Include(o => o.Book).Include(o => o.User);
        ...
        [Authorize(Roles = "User")]
        public async Task<IActionResult> Create([Bind("Id,Status,Location,UserId,BookId")] Order order)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Admin")]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Status,UserId,BookId")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
